...
@section('content')
	...
	<p>
      ...
      <button id="remove-switchings" class="btn btn-danger" data-toggle="modal" data-target="#remove-all">
        <span class="glyphicon glyphicon-remove-sign" aria-hidden="true"></span> 刪除所有調課</button>
	</p>
...
$(document).ready(function() {
    ...
    $('#remove-all').find('.confirm').on('click', function (e) {
        var $modal = $('#remove-all');
        $.ajax(
            {
                url: '/classSwitchings',
                method: 'DELETE',
...
@include('partials.modal',
    ['id' => 'remove-all',
    'message' => '你確定要清空目前所有的調課紀錄？ (與其相關的所有資料會一併刪除，且無法復原)'])
